...
/*
   ...
   to the GVPAPP structure:
      ...
      PGVPAPP ggetapp_vp( SGUCHAR vp ) Get pointer to GVPAPP for specified viewport
   ...
   structure. It only refer to the structure via a pointer. You may therefore 
   define the structure content as you like to fit your application.

   Note:
   The ginit() function does not modify or use any of the GVPAPP data members.
   The GVPAPP structures can therefore be initiated for the first time
   ...
   applications.
   In other system using a union of application specific data structures may be 
